...
public class Config {
	...
	public void loadConfiguration() {
		if (!(plugin.getConfig().getDouble("ArcherGames.technical.version") == 0.1)) {
			...
			plugin.getConfig().set("ArcherGames.game.overtimeWorldRadius", 50);
			...
			plugin.getConfig().set("ArcherGames.strings.noblockediting", "§4You cannot edit blocks until the game begins!");
			plugin.getConfig().set("ArcherGames.strings.nochestediting", "§4You cannot access this until the game begins!");
			plugin.getConfig().set("ArcherGames.strings.nodroppickup", "§4You cannot drop or pick up items until the game begins!");
