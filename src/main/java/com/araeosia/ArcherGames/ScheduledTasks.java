				...
				public void run() {
					switch (gameStatus) {
						case 1:
							...
							// Pre-game
							if (preGameCountdown - currentLoop % 3600 == 0 || preGameCountdown - currentLoop == 60 || preGameCountdown - currentLoop % 60 == 0 || preGameCountdown - currentLoop < 10 || preGameCountdown - currentLoop == 15 || preGameCountdown - currentLoop == 30) {
